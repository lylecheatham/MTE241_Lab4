...
#define SHIP_NUM_X 4
#define SHIP_NUM_Y 3
#define SHIP_ENEMY_SPACING_X 40
#define SHIP_ENEMY_SPACING_Y 40
#define SHIP_EDGE_BUFFER 20
#define SHIP_ENEMY_LEFT_START (SCREEN_X_MIN + SHIP_EDGE_BUFFER)
#define SHIP_ENEMY_TOP_START (SCREEN_Y_MAX - SHIP_EDGE_BUFFER)
